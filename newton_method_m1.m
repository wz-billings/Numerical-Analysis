%{
 MATH 441: Newton's Method (Modified M1)
 Zane Billings
 ...
 % This is modified to account for a root of multiplicity m.
%}
function [root,iterations, error] = newton_method_m1(seed,tol,f,d,m)
